...
- `plan` — `{id, text, agentMessageId}` emitted for plan-mode turns; `text` is the final assistant message for the turn and `agentMessageId` points at the assistant item that produced it.
